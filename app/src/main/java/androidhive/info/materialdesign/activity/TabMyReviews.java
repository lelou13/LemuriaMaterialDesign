 ...
 */
public class TabMyReviews extends Fragment {
    ...
    public static TabMyReviews newInstance() {
        return new TabMyReviews();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.tab_my_reviews, container, false);
    }
